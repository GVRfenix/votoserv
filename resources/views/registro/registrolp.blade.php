...
@section('contenido')
		<div id="form-r" style="width: 75%; margin: 20px auto;">
			...
			<form method="POST" action="almalapaz">
				{!! csrf_field() !!}
				
				
				<h1 class='titulo_lista' id='titulo_registro'>Registro de La Paz</h1>
				...
				<br>
				<h1 class='titulo_lista' id='titulo_registro'>Registro de Mesa Uninominal La Paz</h1>
